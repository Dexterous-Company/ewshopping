                                ...
                                <div className="widget-content filterby filterDD">
                                    <ul className="flex flex-wrap items tags-list">
                                        <li className="item m-1">
                                            <a href="#" className="rounded-full px-3 py-1 bg-gray-100 hover:bg-gray-200">
                                    ...
                                    <a href="#" className="btn btn-sm brd-link mt-2 inline-block text-sm">Clear All</a>
                                </div>
                            </div>
                            {/* End Filter By */}
                                ...
                                <div className="widget-content filterDD">
                                    <ul className="sidebar-categories scrollspy morelist clearfix">
                                        <li className="lvl1 sub-level more-item">
                                            <a href="#" className="site-nav block py-1">Clothing</a>
                                            <ul className="sublinks pl-4">
                                                <li className="lvl2 sub-level sub-sub-level">
                                                    <a href="#" className="site-nav block py-1">Men</a>
                                                    <ul className="sublinks pl-4">
                                                        <li className="lvl3">
                                                            <a href="#" className="site-nav block py-1">Shirt <span className="count">(25)</span></a>
                                                        </li>
                                                        {/* Other sub-items */}
                                                    </ul>
                                                </li>
                            ...
                            <div className="sidebar-widget filterBox filter-widget mb-6">
                                ...
                                <form className="widget-content price-filter filterDD" action="#" method="post">
                                    ...
                                    <div className="flex mt-4">
                                        <div className="w-1/2">
                                            <input id="amount" type="text" className="w-full border rounded p-1" />
                                        </div>
                                        <div className="w-1/2 text-right">
                                            <button className="btn btn-sm bg-blue-500 text-white px-3 py-1 rounded">filter</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div className="sidebar-widget filterBox filter-widget brand-filter mb-6">
                                ...
                                <div className="widget-content filterDD">
                                    <ul className="clearfix">
                                        <li className="mb-2">
                                            <input type="checkbox" defaultValue="avone" id="avone" className="mr-2" />
                                            <label htmlFor="avone">
                                                <span className="mr-1" />Avone
                                            </label>
                                        </li>
                                ...
                                <div className="widget-content filterDD">
                                    <ul className="flex flex-wrap tags-list product-tags">
                                        <li className="item active m-1">
                                            <a className="rounded-full px-3 py-1 bg-blue-500 text-white" href="#">Women</a>
                                        </li>
                                        {/* Other product tags */}
                                    </ul>
                                    <span className="btn btn-sm brd-link btnview inline-block mt-2 text-sm">View all</span>
                                </div>
                            </div>
                            {/* End Product Tags */}
                                ...
                                <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 text-left filters-toolbar-item flex order-1 sm:order-1">
                                    ...
                                    <div className="filters-item flex items-center">
                                        ...
                                        <div className="grid-options view-mode flex">
                                            <a className="icon-mode mode-list block w-8 h-8 border mx-1" data-col={1} />
                                            <a className="icon-mode mode-grid grid-2 block w-8 h-8 border mx-1" data-col={2} />
                                            <a className="icon-mode mode-grid grid-3 hidden md:block w-8 h-8 border mx-1" data-col={3} />
                                            <a className="icon-mode mode-grid grid-4 hidden lg:block w-8 h-8 border mx-1 active" data-col={4} />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="w-1/2 sm:w-1/3 md:w-1/3 lg:w-1/4 item p-2">
                                    <div className="product-box border rounded overflow-hidden">
                                        ...
                                        <div className="product-image relative">
                                            <a href="product-layout1.html" className="product-img block">
                                                <img
                                            ...
                                            <div className="product-labels absolute top-2 right-2">
                                                <span className="lbl on-sale bg-red-500 text-white px-2 py-1 text-xs">Sale</span>
                                            </div>
                                            {/* Countdown Timer */}
                                            <div className="saleTime absolute bottom-2 left-2 bg-black bg-opacity-70 text-white px-2 py-1 text-xs" data-countdown="2025/01/01" />
                                            {/* Product Buttons */}
                                        ...
                                        <div className="product-details text-center p-4">
                                            <div className="product-vendor text-gray-500 text-sm">Tops</div>
                                            <div className="product-name my-2">
                                                <a href="product-layout1.html" className="text-lg font-medium hover:text-blue-500">Oxford Cuban Shirt</a>
                                            </div>
                                            <div className="product-price my-2">
                                                <span className="price old-price line-through text-gray-500 mr-2">$114.00</span>
                                                <span className="price text-blue-500 font-bold">$99.00</span>
                                            </div>
                                            <div className="product-review flex justify-center my-2">
                                                {[...Array(4)].map((_, i) => (
                                                    <i key={i} className="icon anm anm-star text-yellow-400 mx-0.5" />
                                                ))}
                                                <i className="icon anm anm-star-o text-yellow-400 mx-0.5" />
                                                <span className="caption hidden ml-1 text-sm">3 Reviews</span>
                                            </div>
                                            {/* Color Variant */}
                                            <ul className="variants-clr swatches flex justify-center my-2">
                                                {['Navy', 'Green', 'Gray', 'Orange'].map((color, i) => (
                                                    <li key={i} className="swatch medium radius mx-1">
                                                        <span className="swatchLbl block w-8 h-8 border rounded-full overflow-hidden" data-bs-toggle="tooltip" data-bs-placement="top" title={color}>
                                                            <img
                                ...
                                <nav className="clearfix pagination-bottom w-full mt-8">
                                    <ul className="pagination flex justify-center">
                                        <li className="page-item disabled">
                                            <a className="page-link px-3 py-1 border rounded-l" href="#">
                                                <i className="icon anm anm-angle-left-l" />
                                            </a>
                                        </li>
                                        <li className="page-item active">
                                            <a className="page-link px-3 py-1 border bg-blue-500 text-white" href="#">1</a>
                                        </li>
                                        <li className="page-item">
                                            <a className="page-link px-3 py-1 border" href="#">2</a>
                                        </li>
                                        <li className="page-item">
                                            <a className="page-link px-3 py-1 border" href="#">...</a>
                                        </li>
                                        <li className="page-item">
                                            <a className="page-link px-3 py-1 border" href="#">5</a>
                                        </li>
                                        <li className="page-item">
                                            <a className="page-link px-3 py-1 border rounded-r" href="#">
