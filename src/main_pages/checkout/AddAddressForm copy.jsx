        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="relative">
              <label
                className={`absolute left-3 transition-all duration-200 ${
                  focusedFields.Mobile || formData.Mobile
                    ? "top-1 text-xs text-blue-600 bg-white px-1 -ml-1"
                    : "top-3 text-gray-500"
                }`}
              >
                10-digit mobile number{" "}
                {errors.Mobile && <span className="text-red-500">*</span>}
              </label>
              <input
                type="tel"
                name="Mobile"
            ...
            <div className="relative">
              <label
                className={`absolute left-3 transition-all duration-200 ${
                  focusedFields.HNo || formData.HNo
                    ? "top-1 text-xs text-blue-600 bg-white px-1 -ml-1"
                    : "top-3 text-gray-500"
                }`}
              >
                House No/Building{" "}
                {errors.HNo && <span className="text-red-500">*</span>}
              </label>
              <input
                type="text"
                name="HNo"
                className={`border ${
                  errors.HNo ? "border-red-500" : "border-gray-300"
                } px-3 pt-5 pb-2 rounded w-full focus:border-blue-500 focus:ring-1 focus:ring-blue-500`}
              ...
              />
              {errors.HNo && (
                <p className="text-red-500 text-xs mt-1">{errors.HNo}</p>
              )}
            </div>
            ...
            <div className="relative">
              <label
                className={`absolute left-3 transition-all duration-200 ${
                  focusedFields.Area || formData.Area
                    ? "top-1 text-xs text-blue-600 bg-white px-1 -ml-1"
                    : "top-3 text-gray-500"
            ...
            <div className="relative">
              <label
                className={`absolute left-3 transition-all duration-200 ${
                  focusedFields.Pincode || formData.Pincode
                    ? "top-1 text-xs text-blue-600 bg-white px-1 -ml-1"
                    : "top-3 text-gray-500"
                }`}
              >
                Pincode{" "}
                {errors.Pincode && <span className="text-red-500">*</span>}
              </label>
              <input
                type="text"
                name="Pincode"
            ...
            <div className="relative">
              <label
                className={`absolute left-3 transition-all duration-200 ${
                  focusedFields.locality || formData.locality
                    ? "top-1 text-xs text-blue-600 bg-white px-1 -ml-1"
                    : "top-3 text-gray-500"
                }`}
              >
                Locality{" "}
                {errors.locality && <span className="text-red-500">*</span>}
              </label>
              <input
                type="text"
                name="locality"
          ...
          <div className="relative mt-4">
            <label
              className={`absolute left-3 transition-all duration-200 ${
                focusedFields.LandMark || formData.LandMark
                  ? "top-1 text-xs text-blue-600 bg-white px-1 -ml-1"
                  : "top-3 text-gray-500"
              }`}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            ...
            <div className="relative">
              ...
              >
                City/District/Town{" "}
                {errors.City && <span className="text-red-500">*</span>}
              </label>
              <input
                type="text"
                name="City"
            ...
            <div className="relative">
              <label
                className={`absolute left-3 transition-all duration-200 ${
                  focusedFields.Alternative_Mobile ||
